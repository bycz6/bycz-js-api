 ...
 * console.log(err, result);
 * 
 * var release_time = new Date(); console.log("post time: " + result.created);
 * console.log("release time: " + release_time.getDate()); var temp =
 * release_time + 1; console.log("temp: " + temp);
 * 
